...
# TEMPORARY CHANGE FOR NOVEMBER REPORT
# REMOVE AFTER NOVEMBER 2016 REPORT
#flux_df <- dplyr::filter(flux_df, sand_flux>=0)
```
...
# TEMPORARY CHANGE FOR NOVEMBER REPORT ONLY
# REMOVE AFTER NOVEMBER 2016 REPORT
#csc_mass[csc_mass$csc %in% c('1901', '1905', '1906'), ]$sand.mass <- "Flooded"
