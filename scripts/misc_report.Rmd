...
if (nrow(flux_df[flux_df$sand_flux<0, ])>0){
...
# TEMPORARY CHANGE FOR JANUARY BRINE REPORT ONLY
# csc_mass[csc_mass$csc %in% c('1703', '1708', '1710', '1713'), ]$sand.mass <- "Flooded"
# csc_mass[csc_mass$csc %in% c('1701'), ]$sand.mass <- "Site Removed"
