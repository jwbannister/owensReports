...
## Add remove T17-1 and add T23-5 to report
#report_index <- c(report_index[report_index!='T17-1'], 'T23-5')
##rename T10-3E to T10-3
#area_polys[area_polys$id1=='T10-3E', ]$id1 <- 'T10-3'
#area_polys[area_polys$id2=='T10-3E', ]$id2 <- 'T10-3'
#area_polys[area_polys$id3=='T10-3E', ]$id3 <- 'T10-3'
#area_labels[area_labels$id1=='T10-3E', ]$id1 <- 'T10-3'
#area_labels[area_labels$id2=='T10-3E', ]$id2 <- 'T10-3'
#area_labels[area_labels$id3=='T10-3E', ]$id3 <- 'T10-3'
#csc_locs[csc_locs$id1=='T10-3E', ]$id1 <- 'T10-3'
#csc_locs[csc_locs$id2=='T10-3E', ]$id2 <- 'T10-3'
#csc_locs[csc_locs$id3=='T10-3E', ]$id3 <- 'T10-3'
#report_index[report_index=='T10-3E'] <- 'T10-3'
```
...
for (i in report_index){
    ...
    comment_list <- read.table(file=cmnt_fl, sep="", header=F, na.strings="", 
                               skip=1)
    comment_file <- 
        gsub(" ", "_", paste0(area, month(start_date), year(start_date), i, ".txt"))
    ...
    if (area=='twb2' & i!="East"){
        ...
        # one-off comment for November 2017
        if (i=='South'){
        cat(" \n\n## Comments \n")
        cat(" \nThe	PM10 difference	between	the	TEOM monitoring	stations recorded on 11/27/2017 was based	on a single	hour during	which the wind was measured	within 22.5 degrees	(+/-11.25 degrees) between the two stations. The wind was steady out of	the	south-southwest and the recorded wind speed during this hour was approximately 14 meters/second. This day was a high wind day with multiple high PM10 readings across the Owens Valley.\n")	
        }
        cat("<p style=\"page-break-after:always;\"></p> \n")
    }
    if (area=='twb2'& exists('surface_df')){
        ...
        cat("</h6> \n")
        cat(" \n\n## Comments \n")
        cat(" \n Surface survey data was collected Nov. 7 - 9, 2017.\n")
