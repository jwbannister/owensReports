...
for (i in report_index){
    ...
    if (area=='twb2'& exists('surface_df')){
        ...
        cat("</h6> \n")
        cat(" \n\n## Comments \n")
        cat(" \n Surface survey data was collected Jan. 4 - 22, 2018.\n")
        if (i=='South'){
        cat(" \n January surface survey data not available for sites 1606A, 1606B, 1606C, and 1607A.  No safe access to these sites due to flooding.\n")
        }
